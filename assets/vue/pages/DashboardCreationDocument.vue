<template>
  <div v-if="isAuthenticated">
    ...
    <DashboardCreateDocument></DashboardCreateDocument>
  </div>
</template>

<script>
import DashboardCreateDocument from "../pages/components/Document/DashboardCreateDocument";

export default {
  name: "DashboardCreationDocuments",
  components: {
    DashboardCreateDocument
  },
  computed: {
    isAuthenticated() {
